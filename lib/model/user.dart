class User {
  ...
  User({int loginType, int code, Account account, Profile profile, List<Bindings> bindings}) {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    _profile = json['profile'] != null ? new Profile.fromJson(json['profile']) : null;
    if (json['bindings'] != null) {
      _bindings = new List<Bindings>();
      json['bindings'].forEach((v) { _bindings.add(new Bindings.fromJson(v)); });
    }
  }
...
class Account {
  ...
  Account({int id, String userName, int type, int status, int whitelistAuthority, int createTime, String salt, int tokenVersion, int ban, int baoyueVersion, int donateVersion, int vipType, int viptypeVersion, bool anonimousUser}) {
    this._id = id;
  ...
  set whitelistAuthority(int whitelistAuthority) => _whitelistAuthority = whitelistAuthority;
...
class Profile {
  ...
  Profile({int userId, int vipType, int gender, int accountStatus, String nickname, int birthday, int avatarImgId, int city, int backgroundImgId, int userType, bool defaultAvatar, String avatarUrl, int province, int djStatus, Experts experts, bool mutual, Null remarkName, Null expertTags, int authStatus, String backgroundUrl, String description, String avatarImgIdStr, String backgroundImgIdStr, String detailDescription, bool followed, String signature, int authority, String avatarImgId_Str, int followeds, int follows, int eventCount, int playlistCount, int playlistBeSubscribedCount}) {
    this._userId = userId;
    this._vipType = vipType;
    this._gender = gender;
  ...
  set backgroundImgIdStr(String backgroundImgIdStr) => _backgroundImgIdStr = backgroundImgIdStr;
  String get detailDescription => _detailDescription;
  set detailDescription(String detailDescription) => _detailDescription = detailDescription;
  ...
  String get avatarImgId_Str => _avatarImgIdStr;
  set avatarImgId_Str(String avatarImgIdStr) => _avatarImgIdStr = avatarImgIdStr;
  ...
  set playlistBeSubscribedCount(int playlistBeSubscribedCount) => _playlistBeSubscribedCount = playlistBeSubscribedCount;
...
class Bindings {
  ...
  Bindings({String url, bool expired, int userId, String tokenJsonStr, int bindingTime, int expiresIn, int refreshTime, int id, int type}) {
    this._url = url;
